...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <a href="/m/profil" class="btn btn-danger me-2 mb-4"> <span data-feather="arrow-left"></span> Kembali</a>  
                ...
                <div class="card p-3 mb-2">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="mt-5">
                            ...
                            <a href="/m/proyek/{{ $proyek->id }}" class="btn btn-outline-success btn-sm m-2 me-3">Lihat</a>
                        </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                  ...
                  <div class="card-body">
                   ...
                   <a href="/m/blog/{{ $item->slug }}" class="btn btn-outline-success btn-sm">Read More</a>
